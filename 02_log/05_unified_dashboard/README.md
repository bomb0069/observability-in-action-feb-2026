...
- แสดงข้อมูลจากทั้ง Apache logs (flog) และ JSON logs (flog2) ใน dashboard เดียว
...
6. **Automatic Kibana index pattern creation** - สร้างอัตโนมัติผ่าน API
7. **สร้าง unified dashboard** ที่แสดงข้อมูลจากทั้ง 2 sources ในที่เดียว
8. เปรียบเทียบและวิเคราะห์ logs จาก 2 applications (flog มี 1 log/sec, flog2 มี 2 logs/sec)
